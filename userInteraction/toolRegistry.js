...
(function(global) {
  ...
  const BUILTIN_TOOLS = [
    ...
    { id: 'TOOL_WALL_URBAN', name: 'Urban', category: 'Terrain', kind: 'brush', builtin: true, tags: ['city', 'surface', 'skyline'] },
    { id: 'TOOL_WALL_SUBURBAN', name: 'Suburban', category: 'Terrain', kind: 'brush', builtin: true, tags: ['city', 'surface', 'houses'] },
    { id: 'TOOL_WALL_AMERICAN_SUBURBAN', name: 'American Tract', category: 'Terrain', kind: 'brush', builtin: true, tags: ['city', 'surface', 'houses'] },
    ...
    { id: 'TOOL_STATION_2', name: 'Weather Station 2', category: 'Instruments', kind: 'place', builtin: true, tags: ['station', 'obs', 'plot', 'synoptic'] },
    ...
    { id: 'TOOL_TOWN', name: 'Town', category: 'Instruments', kind: 'place', builtin: true, tags: ['town', 'name', 'label', 'place'] },
