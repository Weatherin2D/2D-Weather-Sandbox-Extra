...
const ControlHelp = (function() {
  ...
  const SETTING_HELP = {
    ...
    displayMeteogram: 'Show the time-height meteogram panel for the active weather station (or double-click a station).',
    ...
    floodVizStrength: 'Blue standing-water tint in realistic view when soil moisture exceeds field capacity. Higher = more vivid ponding.',
