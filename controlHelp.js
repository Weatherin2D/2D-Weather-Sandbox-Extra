...
const ControlHelp = (function() {
  ...
  const TOOL_HELP = {
    ...
    TOOL_SYNOPTIC_LOW: {
      title: 'Synoptic Low',
      body: 'Place a low-pressure forcing that draws wind inward. Click an existing L/H marker with this tool to remove it.',
      keys: 'Tool menu → Synoptic Low',
    },
    TOOL_SYNOPTIC_HIGH: {
      title: 'Synoptic High',
      body: 'Place a high-pressure forcing that pushes wind outward. Pair with Coriolis for more persistent domain-scale flow.',
  ...
  const SETTING_HELP = {
    ...
    floodVizStrength: 'Blue standing-water tint in realistic view when soil moisture exceeds field capacity.',
