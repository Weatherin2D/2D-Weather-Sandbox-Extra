...
(function(global) {
  ...
  function isBrushTool(tool) {
    ...
    return tool.startsWith('TOOL_') && ![
      'TOOL_STATION', 'TOOL_STATION_2', 'TOOL_BALLOON', 'TOOL_RADAR', 'TOOL_AIRMASS', 'TOOL_SYNOPTIC_LOW', 'TOOL_SYNOPTIC_HIGH', 'TOOL_DRYLINE', 'TOOL_SEA_BREEZE', 'TOOL_MARKER', 'TOOL_TOWN', 'TOOL_NUKE',
    ].includes(tool);
  }
  ...
  function isPlacementTool(tool) {
    ...
    return [
      'TOOL_STATION', 'TOOL_STATION_2', 'TOOL_BALLOON', 'TOOL_RADAR', 'TOOL_AIRMASS', 'TOOL_SYNOPTIC_LOW', 'TOOL_SYNOPTIC_HIGH', 'TOOL_DRYLINE', 'TOOL_SEA_BREEZE', 'TOOL_MARKER', 'TOOL_TOWN',
